...
function createMenuItem(namestring, pricevalue, categorystring){
    const newItem = {
      name: namestring,
      price: pricevalue,
...
console.log(createMenuItem(`pour-over coffee`, 5, `Drinks`));
console.log(createMenuItem(`biscotti`, 2, `Pastries`)); 
...
function addReview(array, newName, newRating, newFeedback){
  ...
  newObject.rating = newRating;
  newObject.feedback = newFeedback;
